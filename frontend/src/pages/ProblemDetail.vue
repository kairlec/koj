            ...
            <el-scrollbar>
                <div style='padding-right: 8px'>
                    <template v-if='problemFetchError.length'>
                        ...
                        >
                            <template #extra>
                                <el-button type='primary' :loading='refreshing' @click='fetchProblem(undefined,true)'>
                                    刷新
                                </el-button>
                    ...
                    <el-card v-else v-loading='!fetchingFinishState.problemDetail' class='box-card'>
                        ...
                        >
                            ...
                            <el-descriptions-item label='输入' label-class-name='content-label'>
                                {{ problemDetail?.contentObj?.input }}
                            </el-descriptions-item>
                            <el-descriptions-item label='输出' label-class-name='content-label'>
                                {{ problemDetail?.contentObj?.output }}
                            </el-descriptions-item>
                            <template v-for='(item,index) in problemDetail?.contentObj?.samples' :key='index'>
                                <el-descriptions-item :label='`样例输入${index+1}`' label-class-name='content-label'>
                                    <prism-editor
                                        v-model='item.input' class='my-editor' style='background-color: #f8f8f9'
                                        readonly
                                        :highlight='highlighterNothing'></prism-editor>
                                </el-descriptions-item>
                                <el-descriptions-item :label='`样例输出${index+1}`' label-class-name='content-label'>
                                    <prism-editor
                                        v-model='item.output' class='my-editor' style='background-color: #f8f8f9'
                                        readonly
                                        :highlight='highlighterNothing'></prism-editor>
                                </el-descriptions-item>
                            </template>
                            <el-descriptions-item label='提示' label-class-name='content-label'>
                                {{ problemDetail?.contentObj?.hint }}
                            </el-descriptions-item>
                        </el-descriptions>
                    </el-card>
                    <el-card class='box-card'>
                        <template #header>
                            <div class='card-header'>
                                <el-select
v-model='chosenLanguageId' :loading='!fetchingFinishState.languageList'
                                           placeholder='请选择语言'>
                                    <el-option
